...
RSpec.describe ResourceTypesController, :type => :controller do
  ...
  describe "GET #index" do
    it "assigns all resource_types as @resource_types" do
      ...
      expect(assigns(:resource_types)).to eq([resource_type])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested resource_type as @resource_type" do
      ...
      expect(assigns(:resource_type)).to eq(resource_type)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new resource_type as @resource_type" do
      ...
      expect(assigns(:resource_type)).to be_a_new(ResourceType)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created resource_type as @resource_type" do
        post :create, {:resource_type => valid_attributes}, valid_session
        expect(assigns(:resource_type)).to be_a(ResourceType)
        expect(assigns(:resource_type)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved resource_type as @resource_type" do
        post :create, {:resource_type => invalid_attributes}, valid_session
        expect(assigns(:resource_type)).to be_a_new(ResourceType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested resource_type" do
        resource_type = ResourceType.create! valid_attributes
        put :update, {:id => resource_type.to_param, :resource_type => new_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns the resource_type as @resource_type" do
        resource_type = ResourceType.create! valid_attributes
        put :update, {:id => resource_type.to_param, :resource_type => invalid_attributes}, valid_session
        expect(assigns(:resource_type)).to eq(resource_type)
      end
