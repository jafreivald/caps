  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created action as @action" do
        post :create, {:action => valid_attributes}, valid_session
        expect(assigns(:action)).to be_a(Action)
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved action as @action" do
        post :create, {:action => invalid_attributes}, valid_session
        expect(assigns(:action)).to be_a_new(Action)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested action" do
        action = Action.create! valid_attributes
        put :update, {:id => action.to_param, :action => new_attributes}, valid_session
        action.reload
    ...
    context "with invalid params" do
      it "assigns the action as @action" do
        action = Action.create! valid_attributes
        put :update, {:id => action.to_param, :action => invalid_attributes}, valid_session
        expect(assigns(:action)).to eq(action)
      end
