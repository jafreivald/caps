...
RSpec.describe ProfilesController, :type => :controller do
  ...
  let(:valid_attributes) {
    { :first_name => "Bill", :last_name => "McGillicuddy", :email => "bm@nowhere.dev", :userid => "bmcdy", :password => "aw3#FGHJ", :password_confirmation => "aw3#FGHJ"}
  }

  let(:invalid_attributes) {
    { :first_name => "Rachel", :last_name => "McGillicuddy", :email => "bm@nowhere.dev", :userid => "rmcdy", :password => "aw3#FGHJ", :password_confirmation => "aw3#FGHJ" }
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the welcome screen" do
        post :create, {:profile => valid_attributes}, valid_session
...
#    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        { :password => "awq#FGHJ", :password_confirmation => "awq#FGHJ" }
      }
      ...
      it "updates the requested profile" do
        ...
        profile.reload
        expect(:password_digest => "$2a$10$p3b/lDnxNQYLETnNeZ0YtO7TN29t75OEq8tOC5w.yA7FRCCI1LtjC")
      end
